...
# Target size : (34,24)
# A bullet hits the target if the bullet's x-coord is in between targetx and targetx+34
# and the bullet's y-coord is in between targety and targety+24.


###### LESSON 6d ######
#In this lesson, we will detect the event when a bullet hits the target.
# (line 126-129)
# - play the birdsound
# - print("Ouch")
# - make the bullet 'disappear' from the screen
    ...
    def process_game_objects():
        ...
        for i in range (len(bullets)):  #for every bullet in the list
            ...
            if targetx<bullets[i][0]<targetx+34 and targety<bullets[i][1]<targety+24:
                ...
                bullets[i][0]+=400 #bullet 'disappear' from the screen
