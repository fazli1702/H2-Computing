...
# 1. Define the gun nozzle location at (bullet_x,bullet_y):
#       bullet_x, bullet_y = xloc+50, yloc+10
#
# 2. The gun is fired when the player presses the SPACE bar.
#    - a gun sound is heard
#    - store the bullet locations in a list
#
# 3. Iterate through the bullet list to display all the bullet locations.
#
#
# Instructions:
